...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, names='Launch Site', 
                    title='Total Success Launches By site', values='class')
...
def get_scatter_plot(entered_site, selected_range):
    filtered_df = spacex_df[spacex_df['Payload Mass (kg)'].isin(range(selected_range[0], selected_range[1]+1))]
    if entered_site == 'ALL':
